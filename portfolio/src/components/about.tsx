        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          <div>
            <p className="text-lg text-muted-foreground mb-6">
              ...
              việc phát triển các ứng dụng web hiện đại. Tôi có niềm đam mê với
              công nghệ và luôn tìm kiếm những cách thức mới để giải quyết vấn
              đề.
            </p>
            <p className="text-lg text-muted-foreground mb-6">
              Chuyên môn của tôi bao gồm React, Next.js, Node.js, và các công
              nghệ web hiện đại khác. Tôi thích làm việc trong môi trường năng
              động và luôn sẵn sàng học hỏi những điều mới.
            </p>
          </div>
